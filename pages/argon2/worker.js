...
async function loadArgon2(wasmRoot = '.', simd = false, pthread = false) {
    ...
    if (pthread) {
        ...
        const exports$1 = await LoadArgon2Wasm({
            mainScriptUrlOrBlob: url,
            wasmMemory
        });
        return {
            malloc: exports$1._malloc,
            free: exports$1._free,
            argon2i_hash_raw: exports$1._argon2i_hash_raw,
            argon2d_hash_raw: exports$1._argon2d_hash_raw,
            argon2id_hash_raw: exports$1._argon2id_hash_raw,
            memory: wasmMemory
        };
    }
    else {
